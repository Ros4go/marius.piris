class Camera {
  constructor(context, settings = {}) {
    this.lookAt = settings.initialPosition || [0, 0]; // Position de la cible que suit la caméra
  ...
  applyTranslation() {
    this.context.translate(-this.viewport.left, -this.viewport.top); // On bouge l'origine du repère
  }

  updateViewport() { // Mise à jour du viewport
  ...
  moveTo(x, y) { // Bouge la caméra en fonction de l'objet ciblé
    this.lookAt[0] = x;
    this.lookAt[1] = y;
    this.updateViewport();
  }
